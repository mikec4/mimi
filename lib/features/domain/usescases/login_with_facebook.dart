...
class LoginWithFacebook extends UsesCases<User,NoParams> {
  final UserRepository userRepository;

  LoginWithFacebook({this.userRepository}) : assert(userRepository != null);

  @override
  Future<Either<Failures, User>> call({NoParams params}) {
    return userRepository.loginWithFacebook();
  }
